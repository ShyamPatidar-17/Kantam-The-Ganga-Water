    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center py-20 px-6 font-sans">
      ...
      <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl w-full max-w-lg border border-slate-100">
        <div className="text-center mb-8">
            <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase">Join the flow.</h2>
            <p className="text-slate-400 mt-2 text-xs font-bold uppercase tracking-widest">Create a new seller or admin account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="md:col-span-2">
             ...
             <select 
                ...
                className="w-full mt-1 p-4 bg-slate-50 rounded-2xl border-none outline-none focus:ring-2 focus:ring-blue-500 text-sm font-bold"
             >
          ...
          <div className="space-y-4">
            <label className="block">
                ...
                <input name="fullName" required onChange={handleChange} type="text" placeholder="Aditya Sharma" 
                  className="w-full mt-1 p-4 bg-slate-50 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500 text-sm" />
            </label>
            <label className="block">
          ...
          <div className="md:col-span-2 mt-4">
            <button type="submit" className="w-full py-4 bg-slate-900 text-white rounded-2xl font-black hover:bg-blue-600 transition-all shadow-xl uppercase tracking-widest text-sm">
                Register Account
            </button>
          </div>
        </form>
